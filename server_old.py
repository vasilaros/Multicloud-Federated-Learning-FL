        ...
        for tau_setup in tau_setup_all:
            ...
            while True:
                ...
                for n in range(0, n_nodes):
                    ...
                    # conditions for global aggregation of w parameters (for adequate data size and local loss function for each client)    
                    if (data_size_local > ((0.1*0.2* data_size_total_t)) and ((loss_local_last_global.numpy()) < (loss_last_global.numpy())):
